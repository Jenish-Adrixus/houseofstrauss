...
$calculator_text          = '';
$package_name = 'Versandart';
?>
<tr class="woocommerce-shipping-totals shipping">	
	<td class="shippingMain" colspan="2" data-title="<?php echo esc_attr( $package_name ); ?>">
	<?php echo '<h3 class="checkOutTitle">'. wp_kses_post( $package_name ).'</h3>'; ?>
		<!-- <p class="shipNotes">Choose your <?php //echo $package_name; ?> method</p> -->
		<p class="shipNotes"><?=$package_name; ?></p>
