...
echo __( 'Vielen Dank für Ihre Bestellung. Sie ist in der Warteschleife, bis wir bestätigen, dass die Zahlung eingegangen ist. In der Zwischenzeit finden Sie hier eine Erinnerung an Ihre Bestellung:', 'woocommerce' ) . "\n\n"; // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped
