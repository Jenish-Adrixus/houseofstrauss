...
class WC_Countries {
	...
	public function get_default_address_fields() {
		$address_2_label = __( 'APARTMENT, SUITE, EINHEIT, ETC.', 'woocommerce' );
		...
		if ( 'optional' === get_option( 'woocommerce_checkout_address_2_field', 'optional' ) ) {
			$address_2_placeholder = __( 'APARTMENT, SUITE, EINHEIT, ETC. (optional)', 'woocommerce' );
		} else {
		...
		$fields = array(
			...
			'company'    => array(
				'label'        => __( 'FIRMENNAME', 'woocommerce' ),
