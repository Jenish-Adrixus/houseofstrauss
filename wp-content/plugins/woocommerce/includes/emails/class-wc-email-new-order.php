...
if ( ! class_exists( 'WC_Email_New_Order' ) ) :
	...
	class WC_Email_New_Order extends WC_Email {
		...
		public function __construct() {
			$this->id             = 'new_order';
			$this->title          = __( 'Neue Bestellung', 'woocommerce' );
			$this->description    = __( 'Neue Bestellung emails are sent to chosen recipient(s) when a new order is received.', 'woocommerce' );
		...
		public function get_default_subject() {
			return __( '[{site_title}]: Neue Bestellung #{order_number}', 'woocommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'Neue Bestellung: #{order_number}', 'woocommerce' );
		}
