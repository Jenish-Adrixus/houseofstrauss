		...
		switch ( $handle ) {
			case 'user-registration':
				return array(
					...
					'message_required_fields'           => get_option( 'user_registration_form_submission_error_message_required_fields', esc_html__( 'Dieses Feld ist erforderlich.', 'user-registration' ) ),
					'message_email_fields'              => get_option( 'user_registration_form_submission_error_message_email', esc_html__( 'Bitte geben Sie eine gültige E-Mail Adresse ein.', 'user-registration' ) ),
					'message_url_fields'                => get_option( 'user_registration_form_submission_error_message_website_URL', esc_html__( 'Bitte geben Sie eine gültige URL ein.', 'user-registration' ) ),
					'message_number_fields'             => get_option( 'user_registration_form_submission_error_message_number', esc_html__( 'Bitte geben Sie eine gültige Nummer ein.', 'user-registration' ) ),
					'message_confirm_password_fields'   => get_option( 'user_registration_form_submission_error_message_confirm_password', esc_html__( 'Passwort und Bestätigungspasswort stimmen nicht überein.', 'user-registration' ) ),
					'message_validate_phone_number'     => get_option( 'user_registration_form_submission_error_message_phone_number', esc_html__( 'Bitte geben Sie eine gültige Telefonnummer ein.', 'user-registration' ) ),
					'message_username_character_fields' => get_option( 'user_registration_form_submission_error_message_disallow_username_character', esc_html__( 'Bitte geben Sie einen gültigen Benutzernamen ein.', 'user-registration' ) ),
					'message_confirm_email_fields'      => get_option( 'user_registration_form_submission_error_message_confirm_email', esc_html__( 'E-Mail und Bestätigungs-E-Mail stimmen nicht überein.', 'user-registration' ) ),
					'message_confirm_number_field_max'  => esc_html__( 'Bitte geben Sie einen Wert ein, der kleiner oder gleich ist %qty%.', 'user-registration' ),
					'message_confirm_number_field_min'  => esc_html__( 'Bitte geben Sie einen Wert ein, der größer oder gleich ist %qty%.', 'user-registration' ),
					'message_confirm_number_field_step' => esc_html__( 'Bitte geben Sie ein Vielfaches von %qty%.', 'user-registration' ),
					'ursL10n'                           => array(
						'user_successfully_saved' => get_option( 'user_registration_successful_form_submission_message_manual_registation', esc_html__( 'Benutzer erfolgreich registriert.', 'user-registration' ) ),
						'user_under_approval'     => get_option( 'user_registration_successful_form_submission_message_admin_approval', esc_html__( 'Benutzer registriert. Warten Sie, bis der Administrator Ihre Registrierung genehmigt hat.', 'user-registration' ) ),
						'user_email_pending'      => get_option( 'user_registration_successful_form_submission_message_email_confirmation', esc_html__( 'Benutzer registriert. Überprüfen Sie Ihre E-Mail, indem Sie auf den Link klicken, der an Ihre E-Mail gesendet wurde.', 'user-registration' ) ),
						'captcha_error'           => get_option( 'user_registration_form_submission_error_message_recaptcha', esc_html__( 'Captcha-Code-Fehler, bitte versuchen Sie es erneut.', 'user-registration' ) ),
						'hide_password_title'     => esc_html__( 'Passwort verbergen', 'user-registration' ),
						'show_password_title'     => esc_html__( 'Passwort anzeigen', 'user-registration' ),
						'password_strength_error' => esc_html__( 'Die Passwortstärke ist nicht stark genug', 'user-registration' ),
					),
				);
			break;
			...
			case 'ur-password-strength-meter':
				return array(
					'home_url'             => home_url(),
					'i18n_password_error'  => esc_attr__( 'Bitte geben Sie ein sicheres Passwort ein.', 'user-registration' ),
					'pwsL10n'              => array(
						'shortpw'  => esc_html__( 'Sehr Schwach', 'user-registration' ),
						'bad'      => esc_html__( 'Schwach', 'user-registration' ),
						'good'     => esc_html__( 'Mittel', 'user-registration' ),
						'strong'   => esc_html__( 'Stark', 'user-registration' ),
						'mismatch' => esc_html__( 'Passwort mit Bestätigungspasswort stimmt nicht überein.', 'user-registration' ),

					),
					'i18n_password_hint'   => apply_filters( 'user_registration_strong_password_message', esc_html__( 'Tipp: Um das Passwort sicherer zu machen, verwenden Sie Groß- und Kleinbuchstaben, Zahlen und Symbole wie ! " ? $ % ^ & ).', 'user-registration' ) ),
					'i18n_password_hint_1' => esc_html__( 'Hinweis: Mindestens ein Großbuchstabe und 4 Zeichen und keine sich wiederholenden Wörter oder gebräuchliche Wörter', 'user-registration' ),
					'i18n_password_hint_2' => esc_html__( 'Hinweis: Mindestens ein Großbuchstabe, eine Zahl, 7 Zeichen und keine sich wiederholenden Wörter oder gebräuchliche Wörter', 'user-registration' ),
					'i18n_password_hint_3' => esc_html__( 'Hinweis: Mindestens ein Großbuchstabe, eine Zahl, ein Sonderzeichen, mindestens 9 Zeichen und keine sich wiederholenden Wörter oder gebräuchliche Wörter', 'user-registration' ),
				);
				break;
			case 'ur-login':
				return array(
