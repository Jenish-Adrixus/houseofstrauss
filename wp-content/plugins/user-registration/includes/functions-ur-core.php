	...
	$arguments = array(
		...
		'setting_data' => array(
			...
			array(
				...
				'input_class'       => array(),
				'options'           => array(
					'0' => __( 'Sehr Schwach', 'user-registration' ),
					'1' => __( 'Schwach', 'user-registration' ),
					'2' => __( 'Mittel', 'user-registration' ),
					'3' => __( 'Stark', 'user-registration' ),
				),
				'custom_attributes' => array(),
...
if ( ! function_exists( 'ur_process_login' ) ) {
	...
	function ur_process_login( $nonce_value ) {
		try {
			...
			$messages = array(
				'empty_username'   => get_option( 'user_registration_message_username_required', esc_html__( 'Der Benutzername ist erforderlich.', 'user-registration' ) ),
				...
				'unknown_email'    => get_option( 'user_registration_message_unknown_email', esc_html__( 'Ein Benutzer mit dieser E-Mail-Adresse konnte nicht gefunden werden.', 'user-registration' ) ),
