...
class Invoice extends Order_Document_Methods {
	...
	public function __construct( $order = 0 ) {
		// set properties
		$this->type         = 'invoice';
		$this->title        = __( 'Rechnung', 'woocommerce-pdf-invoices-packing-slips' );
	...
	public function get_title() {
		...
		return apply_filters( "wpo_wcpdf_{$this->slug}_title", __( 'Rechnung', 'woocommerce-pdf-invoices-packing-slips' ), $this );
	}
	...
	public function get_number_title() {
		$number_title = __( 'Rechnungsnummer:', 'woocommerce-pdf-invoices-packing-slips' );
	...
	public function get_date_title() {
		$date_title = __( 'Rechnungsdatum:', 'woocommerce-pdf-invoices-packing-slips' );
